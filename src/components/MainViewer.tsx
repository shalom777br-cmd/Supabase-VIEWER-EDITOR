...
export default function MainViewer({
  ...
  return (
    <div className="flex-1 flex flex-col h-screen overflow-hidden bg-white">
      ...
      <div className="px-8 py-5 border-b border-slate-200 bg-white flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between shrink-0">
        <div>
          <div className="flex items-center gap-2">
            ...
            {table.hasUserId && (
              <span className="flex items-center gap-1 text-[10px] bg-emerald-50 text-emerald-700 border border-emerald-200 font-semibold px-2.5 py-0.5 rounded-full">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="text-xs font-semibold px-3.5 py-2 border border-slate-300 hover:bg-slate-50 text-slate-700 bg-white rounded-xl flex items-center gap-1.5 transition"
          >
            {scanningDuplicates ? (
          ...
          <button
            ...
            className="text-xs font-bold px-4 py-2 bg-slate-950 hover:bg-slate-900 text-white rounded-xl flex items-center gap-1.5 shadow-sm transition"
          >
      ...
      <div className="flex-1 overflow-auto bg-slate-50 relative">
        ...
        {!error && data.length === 0 ? (
          <div className="p-16 text-center text-slate-500 flex flex-col items-center justify-center h-full">
            ...
            <p className="font-medium text-sm text-slate-700">レコードが存在しません</p>
            ...
            <thead className="sticky top-0 bg-slate-100 z-10 border-b border-slate-200">
              <tr className="font-semibold text-slate-600">
                ...
                {table.columns.map((col) => (
                  <th key={col.name} className="px-5 py-3.5 font-mono font-medium tracking-tight">
                ...
                {/* Actions column */}
                <th className="px-5 py-3.5 text-center w-28 font-medium">アクション</th>
              </tr>
            </thead>
                ...
                return (
                  <tr
                    ...
                    className={`hover:bg-slate-50/70 transition-all ${
                      isDuplicated
                        ? "bg-amber-50/50 hover:bg-amber-50/80 border-l-2 border-l-amber-400"
                        : isSelected
                        ? "bg-slate-50"
                        : ""
                    }`}
